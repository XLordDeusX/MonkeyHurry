...
namespace Game
{
    public class StarUnits : GameObject
    {
        private Animation idle;

        public StarUnits(string p_name, Transform p_transform) : base(p_name, p_transform)
        {
            idle = CreateAnimation("Idle", "assets/UI/star_", 2, 0, false);
